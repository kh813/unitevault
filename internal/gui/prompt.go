...
// PromptSettingsWindow displays a single native GUI window containing all input fields (Vault path, rclone remote, target folder, interval) inline with Save & Cancel buttons.
